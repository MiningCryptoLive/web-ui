// config
var API = 'https://ergo.miningcrypto.live/api/'; // Change this to your pool API address
...
function loadDashboardData(walletAddress) {
    return $.ajax(API + 'pools/' + currentPool + '/miners/' + walletAddress)
	    ...
	    $('#lastNetworkBlock'),text(dataConvertor(value.networkStats.lastNetworkBlockTime));
